...
// 计算拟合后的数据
const fittedHeatData = timeStampsNumeric.map((x) => {
    let result = 0;
...
console.log(fittedHeatData);
// 在这里得到了拟合后的热度数据 fittedHeatData
// 现在您可以使用 fittedHeatData 在图表中显示多项式拟合的热度数据
    ...
    // 初始化 ECharts 实例并显示图表
    var myChar = echarts.init(document.getElementById('prediction1'));
